  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            Text(name, style: themeData.textTheme.body1),
            Expanded(
              child: AbsorbPointer(
                absorbing: !isActivated,
                child: RangeSlider(
                  activeColor: isActivated ? themeData.primaryColor : themeData.backgroundColor,
                  labels: RangeLabels('${values.start.round()}:00', '${values.end.round()}:00'),
                  divisions: 24,
                  max: 24,
                  min: 0,
                  onChanged: onChanged,
        ...
        children: <Widget>[
          ...
          ExerciseFrequencyPicker(
            ...
            onChangeFrequency: (value) {
              setState(() {
                _notificationSettings.notificationFrequency = value.millisecondsSinceEpoch;
              });
            },
          ),
          SizedBox(height: 16),
